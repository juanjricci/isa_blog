...
describe('Post e2e test', () => {
  ...
  const postSample = {
    title: 'gee gratefully ratify',
    content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=',
    date: '2023-11-23T09:46:34.600Z',
    likes: 31779,
  };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="title"]`).type('duh gadzooks barren');
      cy.get(`[data-cy="title"]`).should('have.value', 'duh gadzooks barren');
      ...
      cy.get(`[data-cy="date"]`).type('2023-11-23T14:00');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2023-11-23T14:00');

      cy.get(`[data-cy="likes"]`).type('13012');
      cy.get(`[data-cy="likes"]`).should('have.value', '13012');
