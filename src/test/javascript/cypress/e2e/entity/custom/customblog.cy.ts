  ...
  describe('Create sample blog and sort by id, name or handle', () => {
    beforeEach(() => {
      cy.authenticatedRequest({
        method: 'POST',
        Authorization:
          'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZG1pbiIsImV4cCI6MTcwMDA0ODEzNSwiYXV0aCI6IlJPTEVfQURNSU4gUk9MRV9VU0VSIiwiaWF0IjoxNjk5OTYxNzM1fQ.ynhO2ybbwwTvWWvGnR3IzG5GzjAnKpMUSFHw7xZdTAIDEV_NW9I1e5eKwCxsEjeljsZmA9nQO-ghJ0ZQvC3Rgw',
        url: '/api/blogs',
        body: blogSample,
        headers: {
