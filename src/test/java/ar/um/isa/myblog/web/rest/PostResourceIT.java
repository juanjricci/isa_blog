...
import ar.um.isa.myblog.IntegrationTest;
import ar.um.isa.myblog.domain.Post;
import ar.um.isa.myblog.repository.PostRepository;
...
class PostResourceIT {
    ...
    public static Post createEntity(EntityManager em) {
        Post post = new Post().title(DEFAULT_TITLE).content(DEFAULT_CONTENT).date(DEFAULT_DATE).likes(DEFAULT_LIKES);
        return post;
    }
    ...
    public static Post createUpdatedEntity(EntityManager em) {
        Post post = new Post().title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE).likes(UPDATED_LIKES);
        return post;
    }
    ...
    void putExistingPost() throws Exception {
        ...
        updatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE).likes(UPDATED_LIKES);
    ...
    void partialUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.content(UPDATED_CONTENT).likes(UPDATED_LIKES);
    ...
    void fullUpdatePostWithPatch() throws Exception {
        ...
        partialUpdatedPost.title(UPDATED_TITLE).content(UPDATED_CONTENT).date(UPDATED_DATE).likes(UPDATED_LIKES);
