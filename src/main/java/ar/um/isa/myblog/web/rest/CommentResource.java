...
import ar.um.isa.myblog.domain.Comment;
import ar.um.isa.myblog.repository.CommentRepository;
...
/**
 * REST controller for managing {@link ar.um.isa.myblog.domain.Comment}.
 */
@RestController
...
public class CommentResource {
     ...
     */
    @GetMapping("")
    public List<Comment> getAllComments(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
