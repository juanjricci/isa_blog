...
import ar.um.isa.myblog.domain.Notification;
import ar.um.isa.myblog.repository.NotificationRepository;
...
/**
 * REST controller for managing {@link ar.um.isa.myblog.domain.Notification}.
 */
@RestController
...
public class NotificationResource {
     ...
     */
    @GetMapping("")
    public List<Notification> getAllNotifications(@RequestParam(required = false, defaultValue = "true") boolean eagerload) {
